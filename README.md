...
![alt text](writeup_images/my_images.jpg) 

The first image is rather difficult because the sign is on the edge of the image and is not completely visible.
...
The model was able to correctly guess 8 of the 8 traffic signs, which gives an accuracy of 100%. One cannot beat 100%.
...
Overall the network is completely sure about the results which to be honest was a little surprising for me (especially for the first two images). Speed limit signs on this small resolution images are rather difficult to differentiate (even for a human) but the model is absolutely sure about its thing. This could signal a possible model error in my opinion but I did not invest more time to evaluate this on a larger set of images.

![alt text](writeup_images/test.jpg) 


### (Optional) Visualizing the Neural Network (See Step 4 of the Ipython notebook for more details)
#### 1. Discuss the visual output of your trained network's feature maps. What characteristics did the neural network use to make classifications?

I did not have time for this, unfortunately.
